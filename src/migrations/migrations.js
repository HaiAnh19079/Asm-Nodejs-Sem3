...
const products = [
    ...
    new Product({
        imagePath: 'https://s2.gaming-cdn.com/images/products/172/orig/bioshock-infinite-cover.jpg',
    ...
    new Product({
        imagePath: 'https://upload.wikimedia.org/wikipedia/ru/c/c8/GTAV_Official_Cover_Art.jpg',
        title: 'GTA V',
    ...
    new Product({
        imagePath: 'https://s1.gaming-cdn.com/images/products/2139/orig/ori-and-the-will-of-the-wisps-pc-xbox-one-cover.jpg',
    ...
    new Product({
        imagePath: 'https://cdn.akamai.steamstatic.com/steam/apps/1036890/ss_44cc5a053ae014caac4b673459bd303d93f6f96a.1920x1080.jpg?t=1623532104',
        title: 'Shadow Warrior 3',
        description: 'Shadow Warrior 3 is an upcoming first-person shooter developed by Flying Wild Hog and published by Devolver Digital. As the sequel to Shadow Warrior 2, the game is set to be released for Windows, PlayStation 4 and Xbox One in 2021.',
        price: 60
    }),
    new Product({
